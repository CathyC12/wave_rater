        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    <a href="#" class="list-group-item active">Lahinch Beach, Co.Clare</a>
                    <a href="#" class="list-group-item">The Velvet Strand, Portmarnock, Co.Dublin</a>
                    <a href="#" class="list-group-item">Tramore Beach, Co.Waterford</a>
                </div>
            </div>
            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    <img class="img-responsive" src="http://www.avalon-guesthouse.com/attachments/Image/surfing_1.jpg?template=generic" alt="">
