...
<body id="page-top">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    <img class="img-responsive" src="img/portfolio/thumbnails/ardmore.jpg" alt="">
                    <div class="caption-full">
                        <h4><a href="#">Island Hopping, Ardmore, Co. Galway</a>
                        </h4>
                        <div id="weather"></div>
                        <p>Current Temp: <span id="temp"></span></p>
                        <p>Current Wind: <span id="wind"></span></p>
                        <p>Address: Island Hopping, Ardmore, Co. Galway</p>
   ...
   <section id="contact">
    ...
    <script>
                        ...
                        weather.open("GET", "https://api.wunderground.com/api/626f24c8c474bb7e/conditions/q/Ireland/Buncrana.json", false);
                        weather.send(null);
