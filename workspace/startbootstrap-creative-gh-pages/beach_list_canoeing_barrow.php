...
<body id="page-top">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    <img class="img-responsive" src="img/portfolio/thumbnails/barrow.jpg" alt="">
                    <div class="caption-full">
                        <h4><a href="#">The Barrow River, Co. Kilkenny & Carlow</a>
                        </h4>
                        <div id="weather"></div>
                        <p>Current Temp: <span id="temp"></span></p>
                        <p>Current Wind: <span id="wind"></span></p>
                        <p>Address: The Barrow River, Co. Kilkenny & Carlow</p>
                        <p>Skip along a line of uninhabited islands with empty sandy beaches and a backdrop of the Twelve Bens and Maamturk mountains, to visit MacDara’s (the patron saint of the Galway Hooker) Island and church.</p>
   ...
   <section id="contact">
    ...
    <script>
                        ...
                        weather.open("GET", "https://api.wunderground.com/api/626f24c8c474bb7e/conditions/q/Ireland/Kilkenny.json", false);
                        weather.send(null);
