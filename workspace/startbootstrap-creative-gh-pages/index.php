                    ...
                    <div class="carousel-inner">
                                ...
                                <ul>
                                    <li class="span3">
                                       <div class ="row">
                                            ...
                                            <a href="http://seasessions.com/"><img src="./img/event1.jpg" sizes="360x240" alt="SeaSession.com"></a>
                                        </div>
                                    ...
                                    <li class="span3"> <div class ="row"> <div align = "left" class="col-lg-4"> <a href="#"><img src="./img/event3.jpg" sizes="360x240" alt="SeaSession.com"></a> </div> <div class="caption col-lg-8"> <h4>50th Anniversary Irish Surfing Association</h4> <p>The 50th Anniversary Celebration of the Irish Surfing Association will take place at the 48th Irish Inter County Surfing Championships scheduled for Rossnowlagh, Donegal on the 15 - 16 October. </p> <a class="btn btn-mini" href="http://www.irishsurfing.ie/blog/277-celebration-50th-anniversary-irish-surfing-association-and-48th-irish-inter-county-surfing-championships.html">&raquo; Read More</a> </div> </div> </li>
                                    <li class="span3">
                                       <div class = "row">
                                        <div align = "center" class="col-lg-4">
                                            <a href="http://www.irishsurfing.ie/"><img src="./img/event2.jpg" sizes="360x240" alt="SeaSession.com" alt=""></a>
                                        </div>
                                        <div class="caption col-lg-8">
                                            <h4>Surfing Intervarsities 2016</h4>
                                            <p>Irish Surfing is delighted to announce that the Irish Surfing Intervarsities 2016 will take place in Strandhill, Co Sligo on the 5/6 March in association with Sligo IT Surf Club. Six titles will be awarded in Men's Surf, Women's Surf, Bodyboard, Longboard and SUP along with the coveted overall club title. The Irish Surfing Intervarsities has been an annual event on the Irish Surfing calendar since the late nineties.</p>
                        ...
                        <div class="item">
                                <ul>
                                    ...
                                    <div class ="row">
                                        <div align = "left" class="col-lg-4">
                                            <a href="#"><img src="./img/event44.jpg" sizes="360x240" alt="wwkc.net"></a>
                                        </div>
                                        <div class="caption col-lg-8">
                                    ...
                                    <li class="span3">
                                     <div class ="row">
                                        <div align = "left" class="col-lg-4">
                                            <a href="#"><img src="./img/event5.PNG" sizes="360x240" alt="www.totalexperience.ie"></a>
                                        </div>
                                        <div class="caption col-lg-8">
                                    ...
                                    <li class="span3">
                                     <div class ="row">
                                        <div align = "left" class="col-lg-4">
                                            <a href="#"><img src="./img/event6.jpg" sizes="360x240" alt="salmonleapcanoeclub"></a>
                                        </div>
                                        <div class="caption col-lg-8">
                        ...
                        <div class="item">
                            <ul>
                                <li class="span3">
                                    <div class ="row">
                                        <div align = "left" class="col-lg-4">
                                            <a href="www.divegalway.com"><img src="./img/event7.jpg" sizes="360x240" alt="DiveGalway"></a>
                                        </div>
                                        <div class="caption col-lg-8">
                                            <h4>Dive Galway</h4>
                                ...
                                <li class="span3">
                                    <div class ="row">
                                        <div align = "left" class="col-lg-4">
                                            <a href="http://www.dingledolphin.com"><img src="./img/event88.png" sizes="360x240" alt="dingle dolphin"></a>
                                        </div>
                                        <div class="caption col-lg-8">
                                ...
                                <li class="span3">
                                         <div class ="row">
                                            <div align = "left" class="col-lg-4">
                                                <a href="https://wildatlanticwildlife.ie/"><img  src="./img/event99.jpg" sizes="360x240" alt="wildatlanticwhildlife"></a>
                                            </div>
                                            <div class="caption col-lg-8">
